...
function displayYear1Modules() {
    for(var i = 0; i < year1Modules.length; i++) {
        ...
        var textnode = document.createTextNode(year1Modules[i].name);
        node.appendChild(textnode);
        node.setAttribute("class", "module-name");

        var moduleNameDiv = document.createElement("div"); // div containing module name
        moduleNameDiv.appendChild(node);
        moduleNameDiv.setAttribute("class", "module-name-div");
        // document.getElementById('year1-content').appendChild(moduleNameDiv);
        ...
        document.getElementById('year1-content').appendChild(moduleFrontContentDiv);

        var img = new Image();
        img.src = backgrounds[i].image;
        img.setAttribute("class", "module-bg");

        // div containing each modules
...
function displayYear2Modules() {
  for(var i = 0; i < year2Modules.length; i++) {
      var node = document.createElement("p");
      var textnode = document.createTextNode(year2Modules[i].name);
      node.appendChild(textnode);
      node.setAttribute("class", "module-name");
      ...
      moduleFrontContentDiv.appendChild(moduleNameDiv);
      moduleFrontContentDiv.setAttribute("class", "module-front-content-div");
      document.getElementById('year2-content').appendChild(moduleFrontContentDiv);
...
function displayYear3Modules() {
  for(var i = 0; i < year3Modules.length; i++) {
      var node = document.createElement("p");
      var textnode = document.createTextNode(year3Modules[i].name);
      node.appendChild(textnode);
      node.setAttribute("class", "module-name");

...
var originalModules = [
  // YEAR 1 CORE MODULES
  {
    ...
    shortName: "fp1",
    description:
      "A broad introduction to the field of IT by exploring the roles and professional practice of IT professionals.",
  ...
  },
  {
    ...
    shortName: "cm",
    description:
      "This module introduces the basic concepts of relations and functions, matrices, statistical methods and relevant applications.",
  ...
  },
  {
    ...
    shortName: "eis",
    description:
      "This module introduces the different components that build up an enterprise information system.",
  ...
  },
  {
    ...
    shortName: "csf",
    description:
      "This module provides an overview of the domains of cyber security to help develop an understanding of its importance in today’s digital world.",
  ...
  },
  {
    ...
    shortName: "fed",
    description:
      "This module teaches the fundamental skills required to develop responsive websites that are optimised for mobile and desktop viewing.",
  ...
  },
  {
    ...
    shortName: "osfnf",
    description:
      "This module focuses on the fundamentals and principles of operating systems.",
  ...
  },
  {
    ...
    shortName: "prg2",
    description:
      "This module provides opportunities for the students to develop medium-scale applications based on the Object-Oriented approach.",
  ...
  },
  {
    ...
    shortName: "ooad",
    description:
      "This module leverages the skills acquired in PRG2 to introduce software design, so that students experience the full cycle of software development.",
  ...
  },
  {
    ...
    shortName: "web",
    description:
      "This module provides students with the skills needed to develop web applications and web application protocol interface (API).",
  ...
  },
  {
    ...
    shortName: "fp3",
    description:
      "This module provides a stepping stone to the students in their IT career. They are given an insight into the infocomm industries.",
  ...
  },
  {
    ...
    shortName: "fsd",
    description:
      "This module aims to provide opportunities for students to be part of a software development team.",
  ...
  },
  {
    ...
    shortName: "ux",
    description:
      "This module focuses on the principles and techniques for designing good user experience in software applications and other products such as ATMs, kiosks, etc.",
  ...
  // AREA OF INTEREST: BUSINESS AND DATA ANALYTICS
  {
    ...
    shortName: "bd",
    description:
      "This module also covers the whole technology stack of Big Data: infrastructure, data management and analytics.",
  ...
  },
  {
    ...
    shortName: "dv",
    description:
      " This module covers the techniques for creating effective visualisations based on principles from graphic design, perceptual psychology, etc.",
  ...
  },
  {
    ...
    shortName: "da",
    description:
      "This module aims to teach students the descriptive analytics lifecycle.",
  ...
  },
  {
    ...
    shortName: "pa",
    description:
      "This module introduces students to the statistical techniques used to make predictions about future trends in business or financial services.",
  ...
  },
  {
    ...
    shortName: "qa",
    description:
      "This module aims to introduce students to the methods that are used to analyse and interpret business or financial data.",
  ...
  },
  {
    ...
    shortName: "dmcd",
    description:
      "This module covers analysis, design and management of cloud database models.",
  ...
  },
  {
    ...
    shortName: "dca",
    description:
      "This module covers the analysis of business and technical requirements of a cloud-based system.",
  ...
  // AREA OF INTEREST: GAME PROGRAMMING
  {
    ...
    shortName: "aig",
    description:
      "This module introduces the various approaches for injecting intelligence into games.",
  ...
  },
  {
    ...
    shortName: "gi",
    description:
      "This module introduces game interactivity and the various game interaction devices to the students. Includes player profiling and psychology, measuring playability, etc.",
  ...
  },
  {
    ...
    shortName: "gpn",
    description:
      "This module provides an overview of the game development process and introduces game design. Storytelling, game mechanics and level design will be covered.",
  ...
  },
  {
    ...
    shortName: "gpp",
    description:
      "This module presents fundamental concepts of game implementation and architecture.",
  ...
  },
  {
    ...
    shortName: "mg",
    description:
      "This module provides an in-depth examination of the various mathematical concepts that are relevant to games programming.",
  ...
  // AREA OF INTEREST: MOBILE BUSINESS APPLICATION
  {
    ...
    shortName: "mad",
    description:
      "This module focuses on the design & development of mobile applications.",
  ...
  },
  {
    ...
    shortName: "mad2",
    description:
      "This module will focus on the development of advanced applications.",
  ...
  },
  {
    ...
    shortName: "mdsf",
    description:
      "This module covers techniques and tools to extract digital evidence on mobile devices.",
  ...
  // AREA OF INTEREST: SOLUTION ARCHITECT
  {
    ...
    shortName: "aooad",
    description:
      "This module introduces complex design artefacts needed to model & document softwares.",
  ...
  },
  {
    ...
    shortName: "dsa",
    description:
      "This module provides students with skills to analyse, design and implement programmes involving data structures.",
  ...
  },
  {
    ...
    shortName: "ecad",
    description:
      "This module aims to provide students with technical skills to develop eCommerce applications.",
  ...
  },
  {
    ...
    shortName: "ssd",
    description:
      "This module trains students to incorporate security throughout the entire process of software development.",
  ...
  // GENERAL ELECTIVES
  {
    ...
    shortName: "eti",
    description:
      "This module is designed to help students keep abreast of the latest IT developments.",
